		...
		require('telescope').setup {
			pickers = {
				help_tags = {
					mappings = {
						i = {
							-- Open help entries as vsplit
							-- TODO: this will always open a new vsplit, find something more robust if not using window_manager
							['<CR>'] = 'file_vsplit',
						},
					},
				},
			...
			defaults = {
				mappings = {
					n = {
						-- My custom Capslock binding to ensure it behaves the same as the esc key
